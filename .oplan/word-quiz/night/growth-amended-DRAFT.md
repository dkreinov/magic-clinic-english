...
> This file is a PROPOSAL for what `docs/growth.md` should become. It does not replace that file.
> `docs/growth.md` is unchanged and still reads `STATUS: AWAITING-OWNER-SIGN-OFF`. If you sign
> section 12 of this draft, the next run copies this text over `docs/growth.md` as one edit and
> then builds sections 5 and 8.
