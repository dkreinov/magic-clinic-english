...
*Rewritten in full at every update. Last update: Phase 1 building — steps 1-3 of 6 accepted.*

## Where we are

Phase 1 is being built, one step at a time. **3 of 6 steps are done and committed.**

```mermaid
flowchart LR
    P1{{Phase 1 BUILDING<br/>fix the basics<br/>3 of 6 steps accepted}} --> P2
...
| 1.4 | the service-worker cache bump | next |
