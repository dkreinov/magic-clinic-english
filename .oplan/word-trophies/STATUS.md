...
when the phase closes. Steps 1.1 and 1.2 of 5 are done and saved: her profile format now has a
...
flowchart LR
    ...
    S12 --> S13[1.3 the award function<br/>RUNNING NEXT]
...
profile untouched, the app's pages byte-identical. The suite grew 303 -> 316 tests, all
