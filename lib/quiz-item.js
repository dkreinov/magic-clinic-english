...
export function validateItem(item, ctx) {
  ...
  //
  // NOTE FOR WHOEVER PROMOTES THIS: scripts/check-quiz-bank.mjs currently
  // DOWNGRADES this one error to a warning, because 8 items in the shipped bank
  // violate it and rewriting those glosses is a separate job. validateItem is
  // not what downgrades it -- it returns a real error here, as it should. See
  // the RULE-11 PENDING block in the gate.
