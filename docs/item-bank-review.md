...
אלה כל השאלות (items) שהבת שלך תראה במבחן המיון (placement test). המבחן קובע את **רמת ההתחלה** שלה באפליקציה — אם השאלות לא ברורות, לא מדויקות, או קשות/קלות מדי, הרמה שתיקבע תהיה שגויה. אנא עברי על כל הרשימה למטה **לפני** שהילדה עושה את המבחן בפעם הראשונה. זה אמור לקחת כ-30 דקות.
